...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, username, password, **extra_fields):
        """Делаем метод для создания администратора сайта"""
...
class User(AbstractUser):
    ...
    username = models.CharField(
        _('username'),
        max_length=150,
        help_text=_('Имя мользователя должно быть не более 150, '
                    'а так же содержать только буквы, цифры и специальные символы (@/./+/-/_ ).'),
    ...
    is_active = models.BooleanField(verbose_name='Статус активации', default=True),
